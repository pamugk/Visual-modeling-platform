...
class DsmPlatform(
    ...
    fun Model.createEntity(graphId:UUID, name: String, id:UUID = UUID.randomUUID(), prototypeId: UUID? = null,
                           maxCount:Int = -1):UUID {
        val entity = MLEntity(graphId, id, name, prototypeId, null, maxCount)
